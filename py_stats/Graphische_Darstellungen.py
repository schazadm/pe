...
# df = pd.read_csv('time_series_crane.csv')
...
plt.figure(9)
plt.plot(df['t'], df['pg(t)'], color='blue')
# plt.plot(df['t'], df['p2(t)'], color='red')
plt.xlabel('Zeit t [s]')
plt.ylabel('Impuls p [Ns]')
plt.title('Gesamtimpuls in Abhängigkeit der Zeit\np(t)')
# plt.title('Teilaufgabe_02: Grafische Darstellung des Kraft Zeitreihe_02')
plt.legend(['Würfel 1', 'Würfel 2'])
plt.grid()

# plt.figure(10)
# plt.plot(df['x1(t)'], df['y1(t)'], color='blue')  # Teilaufgabe_02
# plt.xlabel('x-Koordinate [m]')
# plt.ylabel('y-Koordinate [m]')
# plt.title('Ortsdiagramm der Bewegung')
# # plt.legend(['Würfel 1', 'Würfel 2'])
# plt.grid()

# plt.figure(11)
# plt.plot(df['t'], df['def(t)'], color='red')
# plt.xlabel('Zeit t [s]')
# plt.ylabel('Winkel α')
# plt.title('Auslenkung α als Funktion der Zeit')
# # plt.title('Teilaufgabe_02: Grafische Darstellung des Kraft Zeitreihe_02')
# plt.legend(['Winkel α'])
# plt.grid()
